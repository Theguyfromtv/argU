    ...
    return (
      ...
      <div >
       <div className="top-bar">
         <h6>{this.props.user.name}'s Arguments<button className="btn btn-lg btn-link btn-sidebar topicsButton" onClick={this.toggleTopics.bind(this)}><i className="fas fa-gavel"></i></button></h6>
